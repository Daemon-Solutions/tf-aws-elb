...
variable "elb_port4" {
  desription = "The fourth port for your ELB to listen on"
  type = "string"
  default = "8443"
}

variable "elb_proto4" {
  desription = "The fourth protocol for your ELB to listen on"
  type = "string"
  default = "http"
}

variable "backend_port4" {
  desription = "The fourth port that the ELB will route backend traffic on"
  type = "string"
  default = "8443"
}

variable "backend_proto4" {
  desription = "The fourth protocol that the ELB will route backend traffic on"
  type = "string"
  default = "http"
}

variable "ssl_cert_id4" {
  desription = "The ARN of a TLS certificate you have uploaded to AWS IAM for use with the fourth listener. Only valid for protocols HTTPS or SSL"
  type = "string"
  default = ""
}
